...
dist/personal-os-wiki-v0.2.0.tar.gz   # created when tar is available
dist/SHA256SUMS.txt
```
...
```bash
pwsh ./scripts/package-release.ps1 -Version 0.2.0
gh release create v0.2.0 dist/personal-os-wiki-v0.2.0.zip dist/SHA256SUMS.txt --title v0.2.0 --generate-notes
gh release upload v0.2.0 dist/personal-os-wiki-v0.2.0.tar.gz --clobber
```
