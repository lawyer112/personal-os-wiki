...
7. Read Obsidian Bridge Plan if you are connecting Personal Wiki to Obsidian.
8. Read Object Knowledge Rebuild Manual if you are working on the long-term
   Wiki/object/graph rebuild.
9. Read the macOS guide if the target host is a Mac.
10. Read the comparison document if you are judging positioning.
11. Read the architecture document in your preferred language.
12. Read the Agent guide and Agent Job Orchestration if you are reviewing worker execution.
13. Read Web Capture if you are reviewing passive collection from browser/manual sources.
14. Read Data Safety before connecting real notes, tasks, reminders, or server data.
15. Read Open Source Release Process before publishing or making the repository public.
