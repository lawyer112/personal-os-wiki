...
diff --git a/personal-os-app/vitest.config.ts b/personal-os-app/vitest.config.ts
index 4ee6eb1..85d2563 100644
--- a/personal-os-app/vitest.config.ts
+++ b/personal-os-app/vitest.config.ts
...
diff --git a/tests/services/wiki-client.test.ts b/tests/services/wiki-client.test.ts
new file mode 100644
index 0000000..94b84bb
--- /dev/null
+++ b/tests/services/wiki-client.test.ts
@@ -0,0 +1,113 @@
...
diff --git a/tests/services/wiki-ingest.test.ts b/tests/services/wiki-ingest.test.ts
new file mode 100644
index 0000000..0688001
--- /dev/null
+++ b/tests/services/wiki-ingest.test.ts
@@ -0,0 +1,59 @@
+import { afterEach, describe, expect, it, vi } from "vitest";
+
+const wikiInput = {
...
diff --git a/tests/routes/intake-wiki-fallback.test.ts b/tests/routes/intake-wiki-fallback.test.ts
new file mode 100644
index 0000000..36efac4
--- /dev/null
+++ b/tests/routes/intake-wiki-fallback.test.ts
@@ -0,0 +1,179 @@
+import { afterEach, describe, expect, it, vi } from "vitest";
+
